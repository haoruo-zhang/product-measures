...
def solver(D,d,L,rho,target_value,target_relative_error,gtol,ftol,maxcor,x,polynomial):
    ...
    maxcor is the maximum number of variable metric corrections used to define the limited memory matrix. (The limited memory BFGS method does not store the full hessian but uses this many terms in an approximation to it.)
